...
THREE.ShaderExtras = {
	...
	'dotscreen': {
		...
		fragmentShader: [
			...
			"float pattern(float oo) {",

				"float s = sin( angle ), c = cos( angle );",

				"vec2 tex = vUv * tSize - center + oo;",
				"vec2 point = vec2( c * tex.x - s * tex.y, s * tex.x + c * tex.y ) * scale;",

				"return 1.0 + ( sin( point.x ) * sin( point.y ) ) * 0.15;",
			...
			"void main() {",
				...
				"gl_FragColor = vec4( color.r * pattern(0.1), color.g * pattern(0.3), color.b * pattern(0.5), color.a );",
